...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 18, 2015 at 09:22 AM
...
--
-- Table structure for table `applicationpath`
--

CREATE TABLE IF NOT EXISTS `applicationpath` (
  `id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `application_settings` (
  ...
  `applicationpath_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `application_settings` (`ID`, `application_name`, `application_path`, `applicationpath_id`) VALUES
(9, 'application', '', 0),
(10, 'ms word', 'C:\\Program Files (x86)\\Microsoft Office\\Office12\\WINWORD.EXE', 0),
(11, 'ms powerpoint', 'C:\\Program Files (x86)\\Microsoft Office\\Office12\\POWERPNT.EXE', 0),
(12, 'visual studio', 'F:\\Program Files (x86)\\Microsoft Visual Studio 10.0\\Common7\\IDE\\devenv.exe', 0),
(13, 'dreamweaver', 'C:\\Program Files (x86)\\Adobe\\Adobe Dreamweaver CS6\\Dreamweaver.exe', 0),
...
(21, '2015-02-17', 'masbang, jeanel martirez', '10-1168', 'yes', 'yes', 'BSIT CT 4A', 'PROGRAMMING');
...
(NULL, 'close', 'close', NULL, NULL, 'yes');
...
(43, 114, 'Mondays', '07:00:00', '10:00:00', 'Online'),
(44, 115, 'Fridays', '04:30:00', '07:30:00', 'Offline');
...
(116, 'ct4a', 'oop', 115, 'jeanel', 44, 'Offline', 'jeanel');
...
('10-1168', '', '169.254.232.188', 'masbang, jeanel martirez', 'registered', 'masbang', 'jeanel', 'martirez', '66853716d7e58838d20e', 0, '00:00:00'),
('11-1548', 'loggedin', '169.254.147.107', 'camacho, sonny boy a', 'registered', 'camacho', 'sonny boy', 'a', '2a9e0ad6748bf0101d0a', 0, '00:00:00'),
...
(48, '15-0001', 'bsit ct 4a', 'programming', 'darwin', '07:00:00', '10:00:00', 'Mondays', 'yes', ''),
(49, '15-0001', 'BSIT CT 4A', 'PROGRAMMING 2', 'abrenica', '10:00:00', '11:00:00', 'Mondays', '', ''),
(50, '11-1548', 'BSIT CT 4A', 'PROGRAMMING 3', 'abrenica2', '07:00:00', '08:00:00', 'Mondays', '', ''),
(51, '10-1168', 'BSIT CT 4A', 'PROGRAMMING', 'abrenica', '07:00:00', '10:00:00', 'Mondays', '', ''),
(52, '10-1168', 'BSIT CT 4A', 'PROGRAMMING 2', 'abrenica', '10:00:00', '11:00:00', 'Mondays', '', '');
...
INSERT INTO `type` (`ID`, `word`, `print`, `user_id`, `enabled`, `category`) VALUES
(1, 'begin', '<', '14', 'no', 'html'),
(2, 'html', 'html>', '14', 'no', 'html'),
(4, 'end', '</', '14', 'no', 'html'),
(5, 'head', 'head>', '14', 'no', 'html'),
(6, 'title', 'title>', '14', 'no', 'html'),
(7, 'body', 'body>', '14', 'no', 'html'),
(10, 'int', 'int', '14', 'no', 'html'),
(11, 'semicolon', ';', '14', 'no', 'html'),
(12, 'equals', '=', '14', 'no', 'html'),
(14, 'double-quote', '"', '14', 'no', 'html'),
(15, 'hello-world', 'hello world', '14', 'no', 'html'),
(17, 'read-line', 'ReadLine', '14', 'no', 'html'),
(18, 'Writeline', 'WriteLn', '14', 'no', 'html'),
(19, 'open-close-parenthesis', '{(}{)}', '14', 'no', 'html'),
(20, 'str', 'str', '14', 'no', 'html'),
(21, 'num', 'num', '14', 'no', 'html'),
(26, 'barca', 'Barca', '14', 'no', 'html'),
(27, 'string', 'string', NULL, 'Yes', 'vb.net'),
(28, 'public', 'public ', NULL, 'Yes', 'vb.net'),
(29, 'line', 'line', NULL, 'Yes', 'vb.net'),
(31, 'open-tag', '<?php\r\n', '111', 'no', 'php'),
(35, 'close-tag', '\r\n?>', '111', 'no', 'php'),
(36, 'echo', 'echo ', '111', 'no', 'php'),
(37, 'hello-world', '"hello world"', '111', 'no', 'php'),
(38, 'semicolon', ';', '111', 'no', 'php'),
(42, 'hello-world', '"hello world"', '111', 'Yes', 'vb.net'),
(43, 'messagebox-dot-show', 'MessageBox.show{(}{)}', '111', 'Yes', 'vb.net'),
(45, 'samsungativbook2', 'samsungativbook2', '111', 'Yes', 'vb.net'),
(46, 'Messagebox-dot-show', 'messagebox.show{(}{)}', '111', 'Yes', 'c#');
...
(111, 'abrenica', '50c326e49b283c909e03', 'professor', 'no', 'no', '', '127.0.0.1', '00:00:00'),
...
(114, 'darwin', '34dc8e1804c0a14aeb71', 'professor', 'no', 'no', 'loggedin', '192.168.254.100', '00:00:00'),
(115, 'jeanel', '66853716d7e58838d20e', 'professor', 'no', 'no', '', '169.254.87.145', '00:00:00');
